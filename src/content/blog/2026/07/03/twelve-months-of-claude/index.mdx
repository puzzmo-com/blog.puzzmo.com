...
description: "I try to commit to things. My relationship with the craft of programming is significantly more intense than most of the people I have worked with in my career."
...
import ClaudeIframe from "@/components/blog/ClaudeIframe.tsx";
import HoverImage from "@/components/blog/HoverImage.astro";
import Iframe from "@/components/blog/Iframe.astro";
...
<ClaudeIframe client:visible src="./chat-messages/index.html" id="chat-messages"></ClaudeIframe>
