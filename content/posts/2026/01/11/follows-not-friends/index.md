...
This starts with showing always friends leaderboards above global leaderboards, and making those friend leaderboards easier to fill out by converting the core relationship metaphor on Puzzmo from "friends" to "follows". Prior today, you could send a friend invite to someone and they would need to accept it. Now, you can simply 'follow' someone to have them show up on your leaderboards and social news.

One of the main goals here is that we want to give Puzzmo a feel that people are playing around you. There six figures of puzzles being completed a day but a lot of the people we raise up to being seen in the user interface are our power players! They are definitely doing interesting plays, but it can also be a bit intimidating to always be compared to them.
